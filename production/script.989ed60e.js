...
$(document).ready(function () {
  ...
  var libraryTimeLine = new TimelineMax({
    paused: true
  });
  /*header vars*/
  ...
  TL.fromTo(header, animationSpeed, {
    y: 1500,
    opacity: 0,
  ...
  }).fromTo(navigation, animationSpeed, {
    y: '-100%',
    opacity: 0,
    ease: animationTimingIn
  }, {
    ...
    opacity: 1,
    ease: animationTimingOut
  }, '-=0.25').staggerFromTo(textInner, animationSpeed, {
    y: '120%',
    ease: animationTimingIn
  }, {
    y: '0%',
    ease: animationTimingOut
  }, 0.15).fromTo(imgContainer, animationSpeed, {
    y: -50,
    opacity: 0,
    ease: animationTimingIn
  }, {
  ...
  galleryTimeLine.fromTo(gallery, animationSpeed, {
    ...
    x: '0%',
    ease: animationTimingOut
  }).fromTo(galleryRevealer, animationSpeed * 0.75, {
    x: '0%',
    ease: animationTimingIn
  }, {
    x: '100%',
    ease: animationTimingOut
  }).fromTo(galleryImageRevealer, animationSpeed, {
    x: '-100%',
    ease: animationTimingIn
  }, {
    x: '100%',
  ...
  new ScrollMagic.Scene({
    ...
    triggerHook: 0.85
  }).setTween(galleryTimeLine).setPin(true).reverse(true) // .addIndicators()
  .addTo(controller);
  /******************************** */
  ...
  new ScrollMagic.Scene({
    ...
    triggerHook: 0.6
  }).setTween(libraryTimeLine) // .addIndicators()
  .setPin(true).reverse(false).addTo(controller);
});
var tl = new TimelineMax();
